...
def lambda_handler(event, context):
    ...
    cont = 0
    if(ext_type == 'txt'):
        s3.download_file("julianbucket19", key, new_ubi)
        line = open(new_ubi, 'r')
        ...
        ubiex = "/bucketexam1bd/stocks/company={}/year={}/month={}/day={}/".format(key_name,doc[0],mes,doc[2])
        ...
        s3.upload_file(new_ubi,"bucketexam1bd",sintaxkey)
        bucket_name = "julianbucket21"
